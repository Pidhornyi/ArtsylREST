...
public class SendButchOnVerificationsAllFormats {
    ...
    public void initialize(){
        ...
        int filesLength = AllFormats.fileName.length;
        ...
        addBatchImagePOJO = addBatchImage.AddBatchImageMethod(AllFormats.fileName[0]);
